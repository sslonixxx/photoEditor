...
import com.example.photoeditor.databinding.FragmentRotatorBinding

class RotatorFragment : Fragment() {
    private var _binding: FragmentRotatorBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRotatorBinding.inflate(inflater, container, false)
